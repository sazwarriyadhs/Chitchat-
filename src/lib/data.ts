  ...
  constructor() {
    ...
    this.chats = [
      ...
      },
      {
        ...
        products: [
            { id: 'prod-s1-1', chatId: 'store-1', sellerId: this.currentUser.id, name: 'Es Kopi Susu Gula Aren', description: 'Perpaduan kopi, susu, dan gula aren yang pas.', price: 18000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s1-2', chatId: 'store-1', sellerId: this.currentUser.id, name: 'Americano', description: 'Kopi hitam klasik untuk penikmat sejati.', price: 15000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s1-3', chatId: 'store-1', sellerId: this.currentUser.id, name: 'Croissant Cokelat', description: 'Pastry renyah dengan isian cokelat lumer.', price: 22000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s1-4', chatId: 'store-1', sellerId: this.currentUser.id, name: 'Teh Melati', description: 'Teh melati hangat yang menenangkan.', price: 12000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s1-5', chatId: 'store-1', sellerId: this.currentUser.id, name: 'Paket Bundling Kopi + Roti', description: 'Pilih kopi dan roti favoritmu dengan harga lebih hemat.', price: 35000, imageUrl: 'https://placehold.co/600x400.png' },
        ]
      },
      {
        id: 'store-2',
        ...
        products: [
            { id: 'prod-s2-1', chatId: 'store-2', sellerId: this.users[4].id, name: 'Novel "Bumi Manusia"', description: 'Karya sastra legendaris oleh Pramoedya Ananta Toer.', price: 95000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s2-2', chatId: 'store-2', sellerId: this.users[4].id, name: 'Buku Komik "One Piece Vol. 100"', description: 'Edisi terbaru petualangan Luffy dan kawan-kawan.', price: 45000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s2-3', chatId: 'store-2', sellerId: this.users[4].id, name: 'Notebook Kulit', description: 'Buku catatan elegan dengan sampul kulit.', price: 120000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s2-4', chatId: 'store-2', sellerId: this.users[4].id, name: 'Kamus Inggris-Indonesia', description: 'Kamus lengkap untuk pelajar dan umum.', price: 150000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s2-5', chatId: 'store-2', sellerId: this.users[4].id, name: 'Pembatas Buku Magnetik', description: 'Penanda buku lucu dengan magnet.', price: 25000, imageUrl: 'https://placehold.co/600x400.png' },
        ]
      },
       {
        id: 'store-3',
        ...
        products: [
            { id: 'prod-s3-1', chatId: 'store-3', sellerId: this.currentUser.id, name: 'Jaket Denim Vintage', description: 'Jaket denim gaya 90-an, kondisi 9/10.', price: 250000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s3-2', chatId: 'store-3', sellerId: this.currentUser.id, name: 'Kemeja Flanel Uniqlo', description: 'Kemeja flanel kotak-kotak, ukuran M.', price: 150000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s3-3', chatId: 'store-3', sellerId: this.currentUser.id, name: 'Tas Tangan Kulit Asli', description: 'Tas kulit asli, brand lokal.', price: 400000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s3-4', chatId: 'store-3', sellerId: this.currentUser.id, name: 'Sneakers Converse All Star', description: 'Ukuran 42, jarang dipakai.', price: 350000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s3-5', chatId: 'store-3', sellerId: this.currentUser.id, name: 'Gaun Musim Panas', description: 'Gaun bunga-bunga, cocok untuk liburan.', price: 180000, imageUrl: 'https://placehold.co/600x400.png' },
        ]
      },
      {
        id: 'store-4',
        ...
        products: [
            { id: 'prod-s4-1', chatId: 'store-4', sellerId: this.users[4].id, name: 'Kaset PS5 "God of War"', description: 'Kondisi mulus, seperti baru.', price: 550000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s4-2', chatId: 'store-4', sellerId: this.users[4].id, name: 'Keyboard Mechanical Rexus', description: 'Blue switch, RGB. Lengkap dengan box.', price: 450000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s4-3', chatId: 'store-4', sellerId: this.currentUser.id, name: 'Mouse Gaming Logitech G102', description: 'Mouse gaming sejuta umat, masih oke.', price: 150000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s4-4', chatId: 'store-4', sellerId: this.users[4].id, name: 'Headset Gaming Steelseries', description: 'Suara jernih, mic berfungsi normal.', price: 600000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s4-5', chatId: 'store-4', sellerId: this.currentUser.id, name: 'Voucher Steam Wallet', description: 'Voucher Steam 100.000 IDR.', price: 98000, imageUrl: 'https://placehold.co/600x400.png' },
        ]
      },
      {
        id: 'store-5',
        ...
        products: [
            { id: 'prod-s5-1', chatId: 'store-5', sellerId: this.currentUser.id, name: 'Nastar Premium', description: 'Nastar dengan isian nanas asli dan mentega Wijsman.', price: 150000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s5-2', chatId: 'store-5', sellerId: this.currentUser.id, name: 'Kastengel Keju Edam', description: 'Kue keju renyah dengan keju Edam asli.', price: 160000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s5-3', chatId: 'store-5', sellerId: this.currentUser.id, name: 'Putri Salju', description: 'Kue manis dengan taburan gula halus.', price: 130000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s5-4', chatId: 'store-5', sellerId: this.currentUser.id, name: 'Sambal Bawang Botolan', description: 'Sambal bawang pedas, dijamin nagih!', price: 35000, imageUrl: 'https://placehold.co/600x400.png' },
            { id: 'prod-s5-5', chatId: 'store-5', sellerId: this.currentUser.id, name: 'Rendang Daging Sapi', description: 'Rendang siap saji (250gr).', price: 85000, imageUrl: 'https://placehold.co/600x400.png' },
        ]
      },
    ];
